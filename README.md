...
For all notable changes see [CHANGELOG](https://github.com/elegoev/basebox-ubuntu-21.04-docker/blob/main/CHANGELOG.md)

## License

Licensed under The MIT License (MIT) - for the full copyright and license information, please view the [LICENSE](https://github.com/elegoev/basebox-ubuntu-21.04-docker/blob/main/LICENSE) file.
